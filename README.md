...
![](Project_1_files/figure-gfm/scatter-1.png)<!-- --> Generally, we see
...
![](Project_1_files/figure-gfm/scatter2-1.png)<!-- --> If we only look
...
ratio of average goals for to average goals against per game. Then we
will compare the Hurricanes to the Whalers, with a break out for regular
...
![](Project_1_files/figure-gfm/goal_ratios-1.png)<!-- --> By this new
Goal Ratio metric, the Hurricanes are the clear winner. Another
interesting observation is that the hurricanes tended to perform
